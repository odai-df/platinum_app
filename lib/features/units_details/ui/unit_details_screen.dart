...
import '../data/models/approved_ai_design_model.dart';
import '../logic/unit_details_cubit.dart';
import '../logic/unit_details_state.dart';
import 'package:intl/intl.dart';
import 'unit_360_view.dart';
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (unit.approvedAiDesigns?.isNotEmpty == true) ...[
                              _DetailsCard(
                                icon: Icons.auto_awesome_rounded,
                                title: "AI Designs",
                                subtitle:
                                    "${unit.approvedAiDesigns!.length} Designs • Tap to view",
                                onTap: () {
                                  _showAiDesigns(
                                    context,
                                    unit.approvedAiDesigns!,
                                  );
                                },
                              ),
                              const SizedBox(height: 10),
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: isLoading
                                ? null
                                : () {
                                    context.read<OrderCubit>().createUnitOrder(
                                          widget.unitId,
                                        );
                                  },
                            child: isLoading
...
void _showAiDesigns(
  BuildContext context,
  List<ApprovedAiDesignModel> designs,
) {
  final List<String> images = [];

  for (final design in designs) {
    if (design.mainImageUrl != null &&
        design.mainImageUrl!.isNotEmpty &&
        !images.contains(design.mainImageUrl)) {
      images.add(design.mainImageUrl!);
    }

    for (final image in design.generatedImages ?? []) {
